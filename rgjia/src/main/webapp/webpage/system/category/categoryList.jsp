...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding:0px;border:0px">
		<t:datagrid name="categoryList" title="menu.sort.management"
			...
			<t:dgCol title="common.icon" field="TSIcon_iconPath"  hidden ="true" treefield="code"
				image="true"></t:dgCol>
			<t:dgCol title="图片" field="image" treefield="image"
				image="true" imageSize="50,50"></t:dgCol>
