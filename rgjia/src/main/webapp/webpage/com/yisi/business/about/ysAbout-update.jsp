...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="ysAboutController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="about" style="width:600px;" class="inputxt" rows="6" name="about" 
						  	 	ignore="ignore"
						  	 	>${ysAboutPage.about}</textarea>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="synopsis" style="width:600px;" class="inputxt" rows="6" name="synopsis" 
						  	 	ignore="ignore"
						  	 	>${ysAboutPage.synopsis}</textarea>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${ysAboutPage.weixinNumber}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${ysAboutPage.projectAddress}'>
							<span class="Validform_checktip"></span>
