...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="ysParamController.do?doAdd" >
		<input id="id" name="id" type="hidden" value="${ysParamPage.id }"/>
		<input id="paramType" name="paramType" type="hidden" value="1"/>
