...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="ysUserController.do?doUpdate" >
		...
		<tr>
			...
			<td class="value">
					  <input id="birthday" name="birthday" type="text" style="width: 150px" 
									ignore="ignore"
		      						class="Wdate" onClick="WdatePicker()"  value='<fmt:formatDate value='${ysUserPage.birthday}' type="date" pattern="yyyy-MM-dd"/>'>
				<span class="Validform_checktip"></span>
