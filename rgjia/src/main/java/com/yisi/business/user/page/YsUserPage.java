...
package com.yisi.business.user.page;
 ...
 *
 */
public class YsUserPage implements java.io.Serializable {
	/**id*/
	...
	private List<YsUserAddressEntity> ysUserAddressList = new ArrayList<YsUserAddressEntity>();
		public List<YsUserAddressEntity> getYsUserAddressList() {
		return ysUserAddressList;
		}
		public void setYsUserAddressList(List<YsUserAddressEntity> ysUserAddressList) {
		this.ysUserAddressList = ysUserAddressList;
		}
	/**保存-用户银行*/
    @ExcelCollection(name="用户银行")
	private List<YsUserBankEntity> ysUserBankList = new ArrayList<YsUserBankEntity>();
		public List<YsUserBankEntity> getYsUserBankList() {
		return ysUserBankList;
		}
		public void setYsUserBankList(List<YsUserBankEntity> ysUserBankList) {
		this.ysUserBankList = ysUserBankList;
		}
	/**保存-用户学历*/
    @ExcelCollection(name="用户学历")
	private List<YsUserDegreeEntity> ysUserDegreeList = new ArrayList<YsUserDegreeEntity>();
		public List<YsUserDegreeEntity> getYsUserDegreeList() {
		return ysUserDegreeList;
		}
		public void setYsUserDegreeList(List<YsUserDegreeEntity> ysUserDegreeList) {
		this.ysUserDegreeList = ysUserDegreeList;
		}
	/**保存-用户图片*/
    @ExcelCollection(name="用户图片")
	private List<YsUserImagesEntity> ysUserImagesList = new ArrayList<YsUserImagesEntity>();
		public List<YsUserImagesEntity> getYsUserImagesList() {
		return ysUserImagesList;
		}
		public void setYsUserImagesList(List<YsUserImagesEntity> ysUserImagesList) {
		this.ysUserImagesList = ysUserImagesList;
		}
	/**保存-用户工作*/
    @ExcelCollection(name="用户工作")
	private List<YsUserWorkEntity> ysUserWorkList = new ArrayList<YsUserWorkEntity>();
		public List<YsUserWorkEntity> getYsUserWorkList() {
		return ysUserWorkList;
		}
		public void setYsUserWorkList(List<YsUserWorkEntity> ysUserWorkList) {
		this.ysUserWorkList = ysUserWorkList;
		}
}
